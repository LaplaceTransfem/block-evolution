...
fn main() {
    ...
    let mut thing: block_graph::Graph<Layer<B>> = block_graph::Graph::new();
    thing.add_layer(0usize, block_graph::burn::Layer::linear(false, 100usize, 10usize, 1f32));
    //thing.add_layer(label: 1, layer: block_graph::burn::Layer::Relu);
    println!("Hello, world!");
}

use {block_graph::{AI,burn::{Value,Layer}}};
*/